        ...
        >
          ...
          >
            <div class="flex items-center justify-center w-12 bg-red-500">
              <Icon name="notification_error" class="w-6 h-6 text-white fill-current" />
            </div>
          ...
          >
            <div class="p-4">
              <div class="flex items-start">
                <div class="shrink-0">
                  <Icon name="notification_success" class="w-6 h-6 text-green-400" />
                </div>
                ...
                <div class="flex ml-4 shrink-0">
                  ...
                  >
                    ...
                    <Icon name="cross" class="w-6 h-6 fill-current" />
                  </button>
                </div>
              </div>
            </div>
